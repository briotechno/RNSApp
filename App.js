...
import Splashscreen from '../GifApk/src/screen/spashscreen';
import Deshboard from '../GifApk/src/screen/deshboard';
  ...
  return (
    <NavigationContainer>
      <Stack.Navigator>
        ...
        <Stack.Screen name="Deshboard" component={Deshboard} options={{headerShown: false}}/>
      </Stack.Navigator>
    </NavigationContainer>
  );
}
